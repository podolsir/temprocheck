...
export const questions: QuestionData[] = [
    ...
    },
    {
        ...
        question:
            "В последние несколько месяцев перед 24.02.2022 вы жили длительное время (несколько месяцев) за пределами Украины?",
        answers: [
            {
        ...
        answers: [
            ...
            },
            {
                ...
                outcome: {
                    result: Result.MAYBE,
                    notices: [
                        "Начиная с середины августа 2025 года многие миграционные службы отказывают в оформлении временной защиты тем, у кого когда-либо была оформлена временная защита или другой вид ВНЖ в другой стране ЕС. Законность таких отказов до конца не ясна. Для выяснения в каждом отдельном случае отказ необходимо будет опротестовывать в нескольких судебных инстанциях. Это может занять несколько месяцев. Вы должны быть морально готовы заниматься этими опротестованиями на равных с немецкой бюрократией. Также прибывающим в такой ситуации часто отказывают в предоставлении общежитий, медицинской страховке и другой социальной помощи.",
                    ],
                },
            },
        ],
